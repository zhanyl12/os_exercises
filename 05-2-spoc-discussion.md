...
class scheduler:
    ...
    def next_proc(self, pid=-1):
		...
		for i in range(1,self.get_num_processes()+1):
			my_pid=(pid+i)%self.get_num_processes()
			if self.proc_info[my_pid][PROC_STATE]==STATE_READY:
				self.curr_proc=my_pid
    ...
    def run(self):
        ...
        while self.get_num_active() > 0:
            ...
            # and add an io completion in the future
                ...
                #YOUR CODE
				assert(self.proc_info[self.curr_proc][PROC_STATE]==STATE_RUNNING)
